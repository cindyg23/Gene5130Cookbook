...
**Side Quest** From Monday Exercise, open a text editor or even excel! And create a metadata file from the small dataset that you ran monday (solution posted on canvas, feel free to run it if you need to do that again!)
...
How many genes are upregulated?? How many are downregulated??

Use the order() fuction to sort the res object by adjusted p values
